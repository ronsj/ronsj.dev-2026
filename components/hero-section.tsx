      ...
      <div className="relative mx-auto max-w-5xl px-6">
        ...
        <div className="mt-10 flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center lg:gap-5">
          ...
          <a
            ...
            className="border-site-border text-site-accent hover:text-site-heading inline-flex items-center justify-center gap-2 rounded-md border px-5 py-2.5 font-mono text-base transition-colors"
          >
